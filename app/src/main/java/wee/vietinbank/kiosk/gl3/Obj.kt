...
class Obj {
    ...
    init {
        ...
        val vertexShader: Int = OverlayRenderer.loadShader(GLES31.GL_VERTEX_SHADER, VERTEX_SHADER_CODE)
        val fragmentShader: Int = OverlayRenderer.loadShader(GLES31.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_CODE)
